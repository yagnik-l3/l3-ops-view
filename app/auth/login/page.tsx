          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-3 py-2 pr-10 text-sm border border-[#30363d] rounded-lg bg-[#161b22] text-[#e6edf3] placeholder-[#6e7681] focus:outline-none focus:border-[#58a6ff] transition-colors"
                placeholder="••••••••"
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 flex items-center px-3 text-[#6e7681] hover:text-[#c9d1d9] transition-colors"
              >
